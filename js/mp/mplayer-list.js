 ...
 * slrc为歌词文件路径 可有可无
 */
 var lyricApi = "music.163.com/api/song/media?id=";

//获取网易云音乐
function music163(i) {return "http://music.163.com/song/media/outer/url?id=" + i + ".mp3"}
function getlrc(i){return lyricApi + i}
...
var mplayer_song = [
    [
        ...
        },
        {
            ...
            "singer": "SLANDER",
            "img": "http://s4.music.126.net/style/web2/img/default/default_list.jpg?param=177y177",
            "src": music163("1364247901"),
            "lrc": "[00:00.00]歌词加载中...",
            "slrc" : "audio/lrc/lig.lrc"
        },
        {
            "name": "最后的旅行",
            "singer": "Rainton桐",
